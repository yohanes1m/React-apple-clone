        ...
        <div className="footer-links-wrapper row">
          <div className="links-wrapper-1 col-sm-12 col-md">
            <h3 onClick={() => toggleSection("section1")}
              className={expandedSections["section1"] ? "expanded" : ""}>Shop and Learn</h3>
            <ul>
              <li>
                <a href="#">Mac</a>
              </li>
          ...
          <div className="links-wrapper-2 col-sm-12 col-md">
            <h3 onClick={() => toggleSection("section2")}
              className={expandedSections["section2"] ? "expanded" : ""}>Services</h3>
            <ul>
              <li>
            ...
            <h3 onClick={() => toggleSection("section3")}
              className={expandedSections["section3"] ? "expanded" : ""}>Account</h3>
            <ul>
              <li>
          ...
          <div className="links-wrapper-3 col-sm-12 col-md">
            <h3 onClick={() => toggleSection("section4")}
              className={expandedSections["section4"] ? "expanded" : ""}>Apple Store</h3>
            <ul>
              <li>
          ...
          <div className="links-wrapper-4 col-sm-12 col-md">
            <h3 onClick={() => toggleSection("section5")}
              className={expandedSections["section5"] ? "expanded" : ""}> For Business</h3>
            <ul>
              <li>
            ...
            <h3 onClick={() => toggleSection("section6")}
              className={expandedSections["section6"] ? "expanded" : ""}>For Education</h3>
            <ul>
              <li>
            ...
            <h3 onClick={() => toggleSection("section7")}
              className={expandedSections["section7"] ? "expanded" : ""}>For Healthcare</h3>
            <ul>
              <li>
                <a href="#">Manage Your Apple ID</a>
              </li>
            ...
            <h3 onClick={() => toggleSection("section8")}
              className={expandedSections["section8"] ? "expanded" : ""}>For Government</h3>
            <ul>
              <li>
                <a href="#">Apple and Education</a>
              </li>
          ...
          <div className="links-wrapper-5 col-sm-12 col-md">
            <h3 onClick={() => toggleSection("section9")}
              className={expandedSections["section9"] ? "expanded" : ""}>Apple Values</h3>
            <ul>
              <li>
                <a href="#">Find a Store</a>
              </li>
            ...
            <h3 onClick={() => toggleSection("section10")}
              className={expandedSections["section10"] ? "expanded" : ""}>About Apple</h3>
            <ul>
              <li>
                <a href="#">Find a Store</a>
              </li>
